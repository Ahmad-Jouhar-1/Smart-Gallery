...
class PersonBestPhotoWidget extends StatelessWidget {
  const PersonBestPhotoWidget({
    super.key,
    required this.personPhoto,
    required this.onTap,
  });

  final PersonPhotoModel personPhoto;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            _BestPhoto(image: personPhoto.image),
            _BestBadge(),
            _BestRate(rate: personPhoto.rate),
          ],
        ),
      ),
    );
